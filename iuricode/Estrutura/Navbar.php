      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <form action="" method="post">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="filtro" name="filtro" class="form-control" onchange="this.form.submit()">
              ...
              <li><a class="dropdown-item" href='table.php'>TABELAS</a></li>
              <li><a class="dropdown-item" href='index.php'>CARDS</a></li>
            </ul>
          </li>
        </form>
        <form action="" method="post">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="filtro" name="filtro" class="form-control" onchange="this.form.submit()">
              ...
              ?>
                <li><a class="dropdown-item" href='historicotable.php?mes=<?php echo $dados['MES']; ?>'><?php echo $dados['MES']; ?></a></li>
              <?php
              }
              ?>
        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown" id="filtro" name="filtro" class="form-control" onchange="this.form.submit()">
              ...
              <li><a class="dropdown-item" href='editar.php'>RELATÓRIOS CADASTRADOS</a></li>
            </ul>
          </li>
